...
function showAllCategory(){
    ...
    for(var i = 0; i < itemArr.length; i+=2){
        item.append('<div class="item_box"><img src="../static/img/' +  itemArr[i]["id"] + '"/><div><p id="item_brand">' + itemArr[i]['brand'] + '</p><p id="item_brand">' + itemArr[i]['name'] + '</p><p id="item_price">' + itemArr[i]['price'] + '원</p></div></div>');
    }
...
function showPant(){
    ...
    item.empty();
    for(var i = 8; i < 16; i++){
        item.append('<div class="item_box"><img src="../static/img/' +  itemArr[i]["id"] + '"/><p id="item_brand">' + itemArr[i]['brand'] + '</p><p id="item_brand">' + itemArr[i]['name'] + '</p><p id="item_price">' + itemArr[i]['price'] + '원</p></div></div>');
    }
}
